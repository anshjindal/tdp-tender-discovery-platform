      ...
      <div className="p-4">
        {auth.isAuthenticated ? (
          <div className="relative">
            ...
            >
              <img
                src={profilePicture || auth.user.profilePicture || defaultAvatar}
                alt="User Profile"
            ...
            {isDropdownOpen.userMenu && (
              <ul className="absolute bottom-full left-0 w-full bg-gray-700 rounded shadow-lg mb-2">
                ...
                <li>
                  <button
                    onClick={() => {
                      if (window.confirm('Reset UI to default state?')) {
                        resetFrontendState();
                      }
                    }}
                    className="block w-full text-left p-3 hover:bg-gray-600 text-yellow-400"
                  >
                    Reset UI State
                  </button>
                </li>
